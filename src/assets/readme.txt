--Modelos para visualización de contenidos
     Tema 1: Video 
    <ng-container *ngIf="selectedContent === 'video'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 1: Video</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <iframe [src]="u1_su1_video1_Url" frameborder="0" allowfullscreen></iframe>
          <ion-button (click)="nextContent()">Siguiente</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>

     Tema 2: Lectura 
    <ng-container *ngIf="selectedContent === 'lecture'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 2: Lectura</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <p>Este es el contenido de la lectura...</p>
          <ion-button (click)="nextContent()">Siguiente</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>
     ...
     Tema 3: Imagen 
    <ng-container *ngIf="selectedContent === 'image'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 3: Imagen</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <img src="path-to-your-image.jpg" alt="Imagen" width="100%">
          <ion-button (click)="nextContent()">Siguiente</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>
     ...
     Tema 4: Quiz 
    <ng-container *ngIf="selectedContent === 'quiz'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 4: Quiz</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <p>Haz clic en el botón de abajo para hacer el quiz.</p>
          <ion-button (click)="goToQuiz()">Ir al Quiz</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>

    Tema 5: Segundo Video 
    <ng-container *ngIf="selectedContent === 'video2'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 5: Segundo Video</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <iframe [src]="u1_su1_video1_Url2" frameborder="0" allowfullscreen></iframe>
          <ion-button (click)="nextContent()">Siguiente</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>

     Tema 6: Segunda Lectura 
    <ng-container *ngIf="selectedContent === 'lecture2'">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Tema 6: Segunda Lectura</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <p>Este es el contenido de la segunda lectura...</p>
          <ion-button (click)="finishAndGoToTest()">Finalizar y volver al Test 1</ion-button>
        </ion-card-content>
      </ion-card>
    </ng-container>
